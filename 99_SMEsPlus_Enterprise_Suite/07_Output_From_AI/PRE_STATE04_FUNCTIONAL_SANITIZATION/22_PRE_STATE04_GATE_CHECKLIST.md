...
| 8 | Thailand-scope candidates = 808 (806 General/Business + 2 Thailand Localization baseline); 1,436 − 521 − 99 − 8 | `21_…` §4 | CLASSIFIED (Boss-approved STEP040101) |
| 9 | 808 derivation explained without forcing counts; 8 non-Thai country-specific excluded | `21_…` §4 | READY FOR INDEPENDENT REVIEW |
...
| # | Control | Evidence | Status |
|---|---|---|---|
| 15 | Boss scope decision recorded (AUTHORIZED CONTROLLED DELTA LEARNING REFERENCE; third-party = lawfully acquired reference evidence) | `01` row 4; `02` header; GAP-004 | CLASSIFIED |
| 16 | Duplicate reconciliation (0 name duplicates; 13 overlap candidates flagged) | `21` §7.1 | CLASSIFIED |
| 17 | Controlled Baseline remains 1,436; 1,505 calculated-only; 69 extras = Controlled Delta references OUTSIDE Active Baseline; NOT combined with 808 | `21` §7.2; PEND-002 | OBSERVED |
...
| 20 | GAP-007 reclassified: lawfully acquired third-party reference evidence; copyright/license conditions remain applicable; purchase evidence confidential/restricted | GAP-007; 03A columns | RESOLVED FOR FUNCTIONAL LEARNING BY BOSS DECISION |
| 21 | GAP-008 closed as Functional Learning Gap; Version 18 authorized reference; new Clean Room V19 implementation required | PEND-001; `21` §8 | CLOSED AS FUNCTIONAL LEARNING GAP |
