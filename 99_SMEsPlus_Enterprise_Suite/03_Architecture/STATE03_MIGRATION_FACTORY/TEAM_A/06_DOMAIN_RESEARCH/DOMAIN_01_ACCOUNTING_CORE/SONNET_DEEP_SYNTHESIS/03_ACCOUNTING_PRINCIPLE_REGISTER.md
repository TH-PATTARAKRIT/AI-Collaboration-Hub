...
| AP-10 | e-Tax invoices/receipts must maintain provable content integrity and origin authenticity | **REGULATORY REQUIREMENT (Thailand)**, scoped to e-Tax documents | **UPGRADED (SONNET-CORR-001):** ETDA official terminology, RETS 21-2562 ([ETDA](https://www.etda.or.th/en/Our-Service/e-tax-Invoice-Receipt-1.aspx)); Electronic Transactions Act (secondary corroboration, [esignglobal.com](https://www.esignglobal.com/blog/use-digital-signature-e-tax-invoices-thailand-rd)) | HIGH, now P1/official-source (for e-Tax scope) |
| AP-11 | Tax invoices must state a serial number as a mandatory particular ('gapless' / audit-flagging is a narrower, still-secondary-sourced characterization) | **REGULATORY REQUIREMENT (Thailand)** | **UPGRADED (SONNET-CORR-001):** Revenue Department of Thailand, official English site, Section 86 text fetched and quoted directly ([rd.go.th](https://www.rd.go.th/english/37741.html)); the stronger gapless/audit claim remains secondary-sourced ([invoicedataextraction.com](https://invoicedataextraction.com/blog/thailand-tax-invoice-requirements)) | HIGH for the mandatory-serial-number element (P1); MEDIUM for gapless/audit-flagging specifically (P4, unchanged) |
