...
| **P07** Thailand tax | This deployment uses `l10n_th 18.0.2.0` with `account_withholding_tax`, `withholding_tax_cert*`, `account_payment.wt_tax_id` / `wt_cert_cancel` — **a different mechanism** from the series-16 custom wizard P01 analysed | Statutory correctness is P07's. P01 records `HOLD — STATUTORY EVIDENCE REQUIRED` |
