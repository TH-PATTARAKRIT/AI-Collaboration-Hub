...
| `P10-F-27` | The `account_accountant` copy of the deferred-line builder has no caller anywhere in the reference root — dead code carrying capability nothing uses. | `AAS-03-2` | **Yes** | VERIFIED FACT |
