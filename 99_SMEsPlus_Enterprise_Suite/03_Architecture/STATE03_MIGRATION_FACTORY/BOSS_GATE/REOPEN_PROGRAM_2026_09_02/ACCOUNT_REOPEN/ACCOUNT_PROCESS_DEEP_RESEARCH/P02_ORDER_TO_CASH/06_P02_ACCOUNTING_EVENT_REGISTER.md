...
| **Double revenue** on one order | **Blocked** through the order path; **not blocked** through a manual invoice or a hand-made credit note. | `FACT VERIFIED` `04_P02_REVENUE_AR_TRACE.md` §4 |
