...
|---|---|---|---|---|
| `U-01` | Module install state | **PARTIALLY RESOLVED.** Closed for the deployed estate — six real registries, class **A** within them (`24`). Open for the **v18 target**, class **D**. | **YES** (residue) | A dump or `ir_module_module` export of `smesplus_th`, or of any Odoo 18 database carrying the P05 custom modules. Caveat: the six registries are a convenience sample, not an enumerated population of deployments. |
