...
| `P07-F-42` | `S1` | Zero-rated and exempt VAT taxes resolve at template load into the tax group `WHT 1%` and therefore settle against the **withholding** control accounts. Seven-step chain traced; posting-path consequence, not only reporting. | **VERIFIED in 4 of 4 databases, 6 company sets** — the best-evidenced finding in this package; `P07-U-20` CLOSED | `06 §3A`, `22 §4.2`, `22 §7.2` |
