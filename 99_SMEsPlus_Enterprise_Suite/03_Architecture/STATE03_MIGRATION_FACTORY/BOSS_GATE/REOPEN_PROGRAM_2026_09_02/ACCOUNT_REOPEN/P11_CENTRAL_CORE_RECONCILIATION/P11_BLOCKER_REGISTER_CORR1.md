...
| `B-17` | `X2-F06` CRITICAL unrepaired | **CRITICAL** | unchanged | — | — | **no — deliberately** | Ten subledger rows re-run against the **stated** rule |
| `B-18` | Five unmarked repairs (`P11-G-03`) | med | unchanged | — | — | no | Convert to marked form; re-run the erasure audit |
...
| **Newly opened by CORR1** | **1** | `B-19` — below |
...
> ### `18 → 19` registered; **2 discharged; 17 open; 0 closed by improved wording.**
>
