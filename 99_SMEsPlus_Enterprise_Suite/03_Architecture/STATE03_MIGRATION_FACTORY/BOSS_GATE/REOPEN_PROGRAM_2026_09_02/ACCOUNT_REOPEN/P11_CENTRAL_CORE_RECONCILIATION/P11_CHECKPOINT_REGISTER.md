...
| `CP-P11C05` | Blocker population reconciled | **COMPLETE — EVIDENCE VERIFIED** | 18 executed → 20 registered; 2 discharged by evidence; 0 by wording |
...
| `CP-P11C12` | Boss Final Gate Pack corrected, lineage preserved | **IN PROGRESS** | `D-1`/`D-5`/`D-10` deltas to land |
