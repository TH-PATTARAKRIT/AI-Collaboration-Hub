...
| `B-21` / `T0-14` | one v19 non-target database | **STRENGTHENED — installed in ALL THREE deployed databases** | `P08` `P08-HO-13`. Scope corrected across two generations. **`exercised` still NOT ESTABLISHED** |
