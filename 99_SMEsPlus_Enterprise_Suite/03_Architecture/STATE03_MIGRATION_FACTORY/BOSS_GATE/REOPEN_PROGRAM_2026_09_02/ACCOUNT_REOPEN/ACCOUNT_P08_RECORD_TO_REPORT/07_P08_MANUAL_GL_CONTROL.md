...
| `MGL-D-05` | Counterparty consolidation | the counterparty recorded on posted items, across every company, with the period lock explicitly suppressed | logged on the counterparty record, not on the affected entries |
