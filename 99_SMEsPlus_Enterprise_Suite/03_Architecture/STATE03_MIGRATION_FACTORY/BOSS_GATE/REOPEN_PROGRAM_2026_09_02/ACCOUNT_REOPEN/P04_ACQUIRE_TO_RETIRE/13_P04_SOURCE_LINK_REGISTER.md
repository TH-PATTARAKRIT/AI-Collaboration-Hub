...
| `EV-DB` | **PostgreSQL custom-format archives — 8 files · 5 snapshots · 4 identities** — `iSMEs` 2026-07-11 (v1.14), `iEVING` 2026-07-23 (v1.14), `BK12MAY26` 2026-08-03 (v1.14), `iTEST02` 2026-07-14 (**v1.16**), `iTEST02` 2026-06-14 (**v1.16**) | read this session | **Database evidence**, added after this package's declared *"no database access was attempted"* was tested and found false (`18` `P04-REV-21`). Four sat in one download directory and **one inside the SMEsPlus working tree**, which the first search missed (`P04-REV-24`). **The two v1.16 archives are rejected by the host's default client (16.15)** and require `postgresql@18`; a reader with only the default client reproduces **three of five** (`P04-REV-23`) |
