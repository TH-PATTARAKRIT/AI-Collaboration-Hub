...
| `01_P04_UPSTREAM_CAPITALIZATION_TRACE.md` | `8c3c7e7d4b26deb0cfa33dc2103586a5a0a1a0c6857121b5dad2b77fc3459a03` |
...
| `10_P04_BLOCKER_REGISTER.md` | `40dbe1546458fabcf5ad051af20d7ed36a084b9bf64ce5a61774495daab33334` |
...
| `18_P04_REVISION_LOG.md` | `2e6d109e08ddc3e66a3903a4e6bb6d617c25e07bdcbcb9bf83090144ef73f5b3` |
...
| Register | Total |
|----------|-------|
| Findings (`P04-F-nn`) defined | **93** (`P04-F-18` withdrawn as a duplicate of `P04-F-23`; `P04-F-86`/`P04-F-87` added at `18` `P04-REV-35`; `P04-F-88`/`P04-F-89` at `P04-REV-36`; `P04-F-90`–`P04-F-92` at `P04-REV-37`; `P04-F-93`/`P04-F-94` at `P04-REV-38`, where **`P04-F-88` is withdrawn one commit after publication**). *Executed in the same command that published this line — see `18` §5* |
| Blockers (`P04-B-nn`) — register rows | **50** — enumerated row by row, 50 distinct identifiers, no duplicates. *The figure stood at 45 and was wrong before this session touched it: four section headings understated their own contents (§4, §6A, §6B, §7A), and the published total agreed with neither the headings nor the rows. Corrected at `18` `P04-REV-38` — this package states that totals are unverified claims and had one in its own governing register.* |
