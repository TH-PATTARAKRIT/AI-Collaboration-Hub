...
| **P04-CTR-05** | The estate **hard-blocks** a disposal at the fiscal lock date and **silently re-dates** a depreciation entry past it. Two asset operations, one lock date, two opposite behaviours **inside a single module** | **High** | **OPEN.** `P04-B-31`, `11` §3 |
