...
| **CONTROLS** | Positive (paths, `U2`, case-sensitive): `BD-ACC-01` **65** · `MTI-50` **27** · `MTI-18` **28** · `privileged` **98** · `FDS_AUDIT.md` present on **186 of 186** branch heads. Negative: `kqz51826_corr5_no_such_token` **0** over the pre-package tree — a fresh, single-use token (`C3-I-02`); **at HEAD it necessarily returns the package files that document it** (`CHB-13`) |
...
| 12 | Runtime-only obligations not closable at Phase SA; 6 vetoes in force | `SA_CORR4_06` §5: 18 of 25 runtime · `SA_CORR4_06` §6: `0 of 8` isolation proofs · `0 of 13` surfaces · `0 of 41` functions · `0 of 52` negative access tests, which `SA_CORR4_10` §6 composes with the 8 substitution tests as `0 of 60` — **a different "60" from CORR3's `0 of 60 proof requirements`** (`CHB-07`) · vetoes enumerated by identifier across CORR2/3/4 text: `AAS-V-01`, `AAS-V-02`, `AAS-V-03`, `RC-V-01`, `CF-V-01`, `CF-V-02` = **6**, each with its issuing text located in the R1/R2 `12_AAS_PLUS_CHALLENGE_VERDICT.md` | **REPRODUCED** |
