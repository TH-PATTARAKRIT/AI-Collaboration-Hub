...
| `CP-IEV-07` | Stage E — four challengers in separate contexts | **THREE OF FOUR RETURNED.** Expert 2 (denominator/identity) did not return before publication; **recorded as a gap, not as a clean result.** Its remit is materially covered by Experts 1 and 4, whose count findings were re-executed independently |
