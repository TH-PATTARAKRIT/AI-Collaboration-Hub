...
Working Branch: claude/governance-index-consolidation-79o8k2
...
## 11. Open Authority Conflicts

1. **STATE02_ESCALATION_AND_REPLACEMENT_RULE_v1.0.md** and **STATE02_OWNERLESS_WORK_REGISTER_v1.0.md**: the repository (merged, controlling) text permits Executive Secretary / Liza a degree of "acting owner assignment" / lists Liza as Accountable Owner on all 8 Ownerless Work Register rows. PR #15 (open, draft, NOT merged) proposes restricting Liza to nomination/escalation only and reassigning Accountable Owner to Boss on all 8 rows. Until Boss reviews and decides on PR #15, the repository text is controlling and the conflict is OPEN.
...
1. **SHA-005** (`STATE02_RACI_REVIEW_RECORD_v1.0.md`, Step 03 manifest): hash mismatch against current file bytes, caused by a legitimate later edit (STEP 03 L99 review commit `db57fa1`) that post-dates the STEP 03 manifest generation commit `3f9c4d8`. Not resolved by any open PR. See `STATE02_GOVERNANCE_INDEX_INTEGRITY_RECORD_v1.0.md`.
2. **SHA-016 / SHA-017** (Step 04 review/verification records): same stale-manifest pattern; a fix exists only in unmerged PR #17, and that fix itself would need re-generation after PR #15 (see Section 11) is decided.
3. No independent Evidence Verifier identity is named anywhere in the State 02 document set (see Section 8).
...
| #15 | OPEN / DRAFT | `d76d7d7c30a7e3ce3ff345f989aafc5eec89061d` | Proposes the Section 11 authority correction |
| #16 | OPEN / DRAFT | `398a3f5cced9dd29c2734985933a2e747b317e1a` | Closure Evidence Pack, archive inventory, full SHA256 recomputation |
| #17 | OPEN / DRAFT | `b1e3634b81c1144f619b459e55348f913b2d8e94` | Step 04 SHA256 recompute and manifest alignment |
...
| IDX-06 | Escalation and Replacement | STATE02_ESCALATION_AND_REPLACEMENT_RULE_v1.0.md | v1.0 (repo) | Step_04_Ownerless_Execution_Control/ | ACTIVE CONTROLLED — CORRECTION PENDING | Executive Secretary / Liza (repo) / Boss (PR #15 proposed) | ChatGPT L99 | Claude Code (partial) | 3f9c4d8 | #13 (merged); #15 (open) | ERPPLUS-94 | STALE HASH pending PR #15 sequencing | CONFLICT — Section 11 | PR #15 disposition |
| IDX-07 | (same function) Ownerless Work Register | STATE02_OWNERLESS_WORK_REGISTER_v1.0.md | v1.0 (repo) | Step_04_Ownerless_Execution_Control/ | ACTIVE CONTROLLED — CORRECTION PENDING | Executive Secretary / Liza (repo) / Boss (PR #15 proposed) | ChatGPT L99 | Claude Code (partial) | 3f9c4d8 | #13 (merged); #15 (open) | ERPPLUS-94 | STALE HASH pending PR #15 sequencing | CONFLICT — Section 11 | PR #15 disposition |
