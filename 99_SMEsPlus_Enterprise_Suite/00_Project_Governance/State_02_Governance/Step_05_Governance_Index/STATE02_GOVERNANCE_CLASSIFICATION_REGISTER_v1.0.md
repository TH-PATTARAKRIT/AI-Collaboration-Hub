...
| GOV-028 | Step_04_Ownerless_Execution_Control/PACKAGE_MANIFEST_SHA256_STATE02_STEP04_OWNERLESS.txt | STEP 04 manifest | UNCLASSIFIED | 2 of 11 hash-comparable rows stale in repo version (fixed only in unmerged PR #17) | None | STALE HASH; also **STALE relative to PR #15's pending authority correction** | ACTIVE CONTROLLED — INTEGRITY EXCEPTION NOTED | YES | YES (regeneration + PR #15/#17 sequencing) | Blocking full integrity PASS |
...
| GOV-033 | Step_04_Ownerless_Execution_Control/STATE02_OWNERLESS_EXECUTION_REVIEW_RECORD_v1.0.md | STEP 04 L99 review record | UNCLASSIFIED | ChatGPT L99 review completed; manifest entry for this file was stale (fix only in unmerged PR #17) | None | None | REVIEW RECORD | NO (already completed) | YES (Boss final approval still pending) | Input to Gate |
