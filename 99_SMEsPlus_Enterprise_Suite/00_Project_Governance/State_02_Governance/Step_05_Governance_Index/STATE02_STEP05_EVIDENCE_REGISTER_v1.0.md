...
| EV-06 | SHA-005 (`STATE02_RACI_REVIEW_RECORD_v1.0.md`) manifest hash was stale; NOW RESOLVED by regenerating the STEP 03 manifest to current bytes (587a1fb…) | Direct `sha256sum -c` on the regenerated manifest reports OK; documented in `STATE02_STEP03_STEP04_FINAL_HASH_RECONCILIATION_v1.0.md` | This package's integrity record §1; final SHA output; reconciliation record | Claude Code (technical only) |
| EV-07 | SHA-016/SHA-017 (Step 04 review/verification records) were stale; NOW RESOLVED by regenerating the Step 04 manifest to current bytes (7f85edf8…, b269496…) after incorporating PR #15 content | Direct `sha256sum -c` reports OK; documented in the reconciliation record | This package's integrity record §2; final SHA output | Claude Code (technical only) |
