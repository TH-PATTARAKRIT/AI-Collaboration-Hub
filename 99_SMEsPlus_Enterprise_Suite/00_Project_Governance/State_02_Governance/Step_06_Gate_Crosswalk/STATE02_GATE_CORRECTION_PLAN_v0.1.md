...
|---|---|---|---|---|---|
| CP-001 | Repository contains 5 independent, non-reconciled Gate sequencing models with no cross-references between them (see `STATE02_GATE_ALIAS_AND_MODEL_CROSSWALK_v1.0.md` §3–4) | `STATE02_GATE_CROSSWALK_v1.0.md` §3 | High | Boss decision on whether to designate one model canonical or formally merge them | OPEN |
